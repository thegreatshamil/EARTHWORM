...
const ChatPage: React.FC<ChatPageProps> = ({ onPageChange: _onPageChange }) => {
  ...
  return (
    <div className="relative h-screen overflow-hidden bg-[#28282B]">
      ...
      <div className="relative z-10 flex h-full gap-4 pt-24 px-4 md:px-8 pb-6">
          ...
          <div className="px-4 sm:px-8 pt-6 pb-5 border-b border-white/10 space-y-4">
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#f4d03f]/30 to-[#d4ac0d]/20 flex items-center justify-center shadow-inner shadow-black/30">
                  <Sprout className="w-6 h-6 text-[#f4d03f]" />
                </div>
                <div>
                  <p className="text-[11px] uppercase tracking-[0.35em] text-white/50">{t('subtitle')}</p>
                  <h1 className="text-2xl font-semibold text-white">{t('varunAI')}</h1>
                </div>
              </div>
              ...
              {!showHistory && (
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="p-3 rounded-2xl bg-white/5 text-white/60 hover:text-white transition-colors"
